...
-- -----------------------------------------------------
-- procedure manaNeizpilditoMarsrutuKopsumma
-- -----------------------------------------------------

DELIMITER $$
USE `DBTeh-kursa_darbs`$$
CREATE PROCEDURE manaNeizpilditoMarsrutuKopsumma(lietotaja_ID INT)
	BEGIN
    SELECT SUM(cena * sedvietas) AS summaNeizpildits FROM marsruti
	JOIN lietotajiem_ir_marsruti ON marsruti_ID=ID
	WHERE lietotaji_ID=lietotaja_ID AND irIzpildits=0;
	END$$

DELIMITER ;

-- -----------------------------------------------------
-- procedure manaIzpilditoMarsrutuKopsumma
-- -----------------------------------------------------

DELIMITER $$
USE `DBTeh-kursa_darbs`$$
CREATE PROCEDURE manaIzpilditoMarsrutuKopsumma(lietotaja_ID INT)
	BEGIN
    SELECT SUM(cena * sedvietas) AS summaIzpildits FROM marsruti
	JOIN lietotajiem_ir_marsruti ON marsruti_ID=ID
	WHERE lietotaji_ID=lietotaja_ID AND irIzpildits=1;
	END$$
