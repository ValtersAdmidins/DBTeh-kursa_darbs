...
-- -----------------------------------------------------
-- function manaIzveidotoIzpilditoMarsrutuSamaksa
-- -----------------------------------------------------

DELIMITER $$
USE `DBTeh-kursa_darbs`$$
CREATE FUNCTION manaIzveidotoIzpilditoMarsrutuSamaksa(lietotaja_ID INT)
	RETURNS DECIMAL(10,2)
    BEGIN
...
-- -----------------------------------------------------
-- function manaIzveidotoNeizpilditoMarsrutuSamaksa
-- -----------------------------------------------------

DELIMITER $$
USE `DBTeh-kursa_darbs`$$
CREATE FUNCTION manaIzveidotoNeizpilditoMarsrutuSamaksa(lietotaja_ID INT)
	RETURNS DECIMAL(10,2)
    BEGIN
