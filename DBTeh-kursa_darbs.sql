...
-- -----------------------------------------------------
-- procedure visiManiMarsruti
-- -----------------------------------------------------

DELIMITER $$
USE `DBTeh-kursa_darbs`$$
CREATE PROCEDURE visiManiMarsruti(lietotaja_ID INT)
	BEGIN
	...
	WHERE lietotaji_ID=lietotaja_ID
...
-- -----------------------------------------------------
-- function manaNeizpilditoMarsrutuKopsumma
-- -----------------------------------------------------

DELIMITER $$
USE `DBTeh-kursa_darbs`$$
CREATE FUNCTION manaNeizpilditoMarsrutuKopsumma(lietotaja_ID INT)
	...
	JOIN lietotajiem_ir_marsruti ON marsruti_ID=ID
	WHERE lietotaji_ID=lietotaja_ID AND irIzpildits=0 INTO kopsumma;
...
-- -----------------------------------------------------
-- function manaIzpilditoMarsrutuKopsumma
-- -----------------------------------------------------

DELIMITER $$
USE `DBTeh-kursa_darbs`$$
CREATE FUNCTION manaIzpilditoMarsrutuKopsumma(lietotaja_ID INT)
	RETURNS DECIMAL(10,2)
    BEGIN
	...
	JOIN lietotajiem_ir_marsruti ON marsruti_ID=ID
	WHERE lietotaji_ID=lietotaja_ID AND irIzpildits=1 INTO kopsumma;
...
SELECT * FROM lietotajiem_ir_marsruti WHERE lietotaji_ID IN (SELECT lietotaji_ID FROM visi_soferi ORDER BY lietotaji_ID DESC);
...
SELECT * FROM lietotajiem_ir_marsruti WHERE lietotaji_ID IN (SELECT lietotaji_ID FROM visi_pasazieri ORDER BY lietotaji_ID DESC);
USE `DBTeh-kursa_darbs`;
