...
CREATE TABLE IF NOT EXISTS `DBTeh-kursa_darbs`.`lietotaji` (
  ...
  `parole` VARCHAR(45) NULL,
  `telefona_numurs` VARCHAR(45) NULL,
  PRIMARY KEY (`ID`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `DBTeh-kursa_darbs`.`transportlidzekli` (
  ...
  `gads` YEAR(4) NULL,
  `krasa` VARCHAR(45) NULL,
  `numura_zime` VARCHAR(45) NULL,
  PRIMARY KEY (`ID`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `DBTeh-kursa_darbs`.`marsruti` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `no_valsts` VARCHAR(45) NULL,
  `uz_valsts` VARCHAR(45) NULL,
  `no_pilseta` VARCHAR(45) NULL,
  `uz_pilseta` VARCHAR(45) NULL,
  `no_adrese` VARCHAR(45) NULL,
  `uz_adrese` VARCHAR(45) NULL,
